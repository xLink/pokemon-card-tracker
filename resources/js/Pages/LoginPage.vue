    ...
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto lg:py-0">
      <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          <form class="space-y-4 md:space-y-6" :action="route('pages.login')" method="POST">
            <div>
            ...
            <div class="flex items-center justify-between">
              ...
              <inertia-link class="font-medium text-blue-600 hover:underline dark:text-blue-500" :href="route('pages.passwordReset')">Forgot Password?</inertia-link>
            </div>
            ...
            <p class="text-sm font-light text-gray-500 dark:text-gray-400">
              Don’t have an account yet? <inertia-link class="font-medium text-blue-600 hover:underline dark:text-blue-500" :href="route('pages.register')">Sign Up</inertia-link>
            </p>
            <csrf />
          </form>
        </div>
